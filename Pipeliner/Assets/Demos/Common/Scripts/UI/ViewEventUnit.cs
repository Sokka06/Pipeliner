...
[UnitTitle("On View Event")]//Custom EventUnit to receive the event. Adding On to the unit title as an event naming convention.
[UnitCategory("Events/UI")]//Setting the path to find the unit in the fuzzy finder in Events > My Events.
public class ViewEventUnit : EventUnit<string>
{
    ...
    {
        return new EventHook(UIEvents.ViewEvent);
    }
